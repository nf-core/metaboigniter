...
```bash
nextflow run nf-core/metaboigniter --reads '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from dockerhub: [`nfcore/metaboigniter`](http://hub.docker.com/r/nfcore/metaboigniter/)
* `singularity`
