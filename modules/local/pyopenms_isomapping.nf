process PYOPENMS_ISOMAPPING{
    ...
    tuple val(meta_feature),path(input_spectra)
    ...
    ismapping.py \\
        --consensus_input $input_target --featurexml $mzml_input --output output/${prefix}.consensusXML $args
